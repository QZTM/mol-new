...
/**
 * 支付宝支付
 * 属性为创建AlipayClient的常亮
 * getPayInfo为静态方法，使用AlipayCreateInfo携带的信息去支付宝服务端申请支付信息
 */
@Data
public class Alipay {
    ...
    public static synchronized Map getPayInfo(AlipayCreateInfo info) throws AlipayApiException {
        ...
        model.setBody(info.getBody());//商品名称
        model.setSubject(info.getSubject());//商品说明或备注
