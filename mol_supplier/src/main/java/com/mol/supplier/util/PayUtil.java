...
public class PayUtil//微信支付需要用到的算法
{
    /**
     * 签名字符串
     *
    ...
    public static String sign(String text, String key, String input_charset) {
        ...
        // return MD5Util.MD5Encode(text.toString(), "UTF-8").toUpperCase();
    }
    ...
    public static String doRefund(String mchId, String url, String filepath,String data) throws Exception {//带证书的退款请求
        /**
    ...
    public static String getRandomStringByLength(int length) {//生成随机字符串
    ...
    public static String getLocalIP() {//获取ip地址
...
//    public static Map doXMLParse(String strxml) //传入xml表解析xml数据返回map
//    {
//        try {
