...
public class WebExpertConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(getSessionExpertInterceptor())
                .addPathPatterns("/**")
                .excludePathPatterns("static/**","static/**/**","/expert/findAll","/microApp/**","/molexpert/**","/css/**","/js/**","/fonts/**","/layui/**","/static/css/**","/static/js/**","/static/fonts/**","/static/layui/**","/microApp/login/**","/zfb/**","/zfb/hi");
    }
